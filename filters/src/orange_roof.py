...
if __name__ == '__main__':
    ...
    contours, hierarchy = cv2.findContours(cv2.Canny(gray, 100, 200).copy(), cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
    ...
    for cnt in cnts:
        if cv2.contourArea(cnt) > 0:  # filter small contours
            ...
            # Pool
            if w > 50 and h > 50 and 200 < y < 300 and 400 < x < 600:
    ...
    # 8. Save the image
    cv2.imwrite('../data/contours_with_rectangles_roof.jpg', contours_image)